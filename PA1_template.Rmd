...
onlyweekend <- filled.activityData[filled.activityData$dayofweek == "weekend", ]

plot(filled.activityData[filled.activityData$dayofweek == "weekend", 3], filled.activityData$steps,
     main = "", xlab = "Interval", ylab = "Number of steps", col = "red")
plot(filled.activityData[filled.activityData$dayofweek == "weekday", 3], filled.activityData$steps,
     main = "", xlab = "Interval", ylab = "Number of steps", col = "blue")
